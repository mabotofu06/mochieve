# Mochieve（もちべ）について
Mochieve（もちべ）は作業進捗を気軽に発信、他の人からのアクションなども見てモチベを上げるための投稿ツール
* 進捗を1つのグループとしてタイムラインに投稿するためこれまでの作業が埋もれないし、発掘してもらえるかも
...
* 認証機能(外部認証OAuthなどを利用)
  ...
  - [x] supabaseAuth
  - [x] その他外部OAuth認証
  - [] cookieとRedisキャッシュを使ったUXを損なわないセッション保持
* 投稿機能
  - [x] 画像アップロード(webp形式)
  - [x] 新規投稿（グループ作成）
  - [x] 追加投稿
